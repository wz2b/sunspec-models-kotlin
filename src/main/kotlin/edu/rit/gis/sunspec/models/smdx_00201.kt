...
@SunSpecModel(id=201, len=105, name="ac_meter")
class Model_201 {
   ...
   @SunSpecPoint(id="PPVphAB", label="Phase Voltage AB", offset=10, len=1, type="int16",
                 description="Phase Voltage AB",
                 notes="Phase Voltage AB")
            
   var PPVphAB: Short? = null

   @SunSpecPoint(id="PPVphBC", label="Phase Voltage BC", offset=11, len=1, type="int16",
                 description="Phase Voltage BC",
                 notes="Phase Voltage BC")
            
   var PPVphBC: Short? = null

   @SunSpecPoint(id="PPVphCA", label="Phase Voltage CA", offset=12, len=1, type="int16",
                 description="Phase Voltage CA",
                 notes="Phase Voltage CA")
            
   var PPVphCA: Short? = null
